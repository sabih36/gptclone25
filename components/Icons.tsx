...
export const KeyIcon: React.FC = () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.623 5.873l-5.49 5.49a2 2 0 01-2.828 0l-1.414-1.414a2 2 0 010-2.828l5.49-5.49A6.001 6.001 0 0117 7z"></path></svg>
);
